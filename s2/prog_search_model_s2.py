...
from prog_search_cells  import NAS201SearchCell as SearchCell

class TinyNetwork_Prog(nn.Module):
    
  def __init__(self, C, N, max_nodes, num_classes, search_space, affine, track_running_stats, arch_flag=None):
